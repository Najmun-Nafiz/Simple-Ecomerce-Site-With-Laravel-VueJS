...
<div class="container-fluid back-images authenticate">
    <div class="row">
        <div class="col-md-6 p-0">
            <div class="card bg-color">
                <div class="position-set">
                    <div class="card-header bg-transparent border-0 ">
                        <h1 class="card-title font-weight-bold text-white">{{ __('Register') }}</h1>
                    </div>
                    ...
                    <div class="card-body pt-0">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="phone" class="col-md-4 col-form-label text-md-right text-white">{{ __('Phone Number') }}</label>
